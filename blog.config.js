...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '183db647877880bfb5a5dc1b0f7db0a7',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Chris', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '想在世界各地写代码', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://anyways.fun', // 网站地址
